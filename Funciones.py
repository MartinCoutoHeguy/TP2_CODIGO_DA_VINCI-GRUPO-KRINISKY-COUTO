...
def filtro_imagen() -> np.array:
    ...
    Image.fromarray(img_lista).save('Imagen_Filtrada.png')
    return img_lista
...
def varianza_menor(varianzaA:int, varianzaB:int, varianzaC:int, varianzaD:int) -> int:
    '''
    La funcion varianz_menor(), toma como paramentro las varianzas, las mete en una lista y 
